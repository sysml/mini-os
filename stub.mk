...
CONFIG_NETFRONT_WAITFORTX_BUSYLOOP ?= n
...
MINIOS_OBJS0-$(CONFIG_NOXS)		+= noxs.o
...
MINIOS_OPT_FLAGS-$(CONFIG_NETFRONT_WAITFORTX_BUSYLOOP)	+= -DCONFIG_NETFRONT_WAITFORTX_BUSYLOOP
...
MINIOS_OPT_FLAGS-$(CONFIG_NOXS)			+= -DCONFIG_NOXS
...
MINIOS_OPT_FLAGS-$(CONFIG_DEBUG_NOXS)		+= -DNOXS_DEBUG
...
LWIP_OPT_FLAGS-$(CONFIG_LWIP_POOLS_ON_HEAP)	+= -DCONFIG_LWIP_POOLS_ON_HEAP
LWIP_OPT_FLAGS-$(CONFIG_LWIP_MINIMAL)		+= -DCONFIG_LWIP_MINIMAL
LWIP_OPT_FLAGS-$(CONFIG_LWIP_WND_SCALE)	+= -DCONFIG_LWIP_WND_SCALE
LWIP_OPT_FLAGS-$(CONFIG_LWIP_PARTIAL_CHECKSUM)	+= -DCONFIG_LWIP_PARTIAL_CHECKSUM
LWIP_OPT_FLAGS-$(CONFIG_LWIP_GSO)		+= -DCONFIG_LWIP_GSO
LWIP_OPT_FLAGS-$(CONFIG_LWIP_BATCHTX)		+= -DCONFIG_LWIP_BATCHTX
